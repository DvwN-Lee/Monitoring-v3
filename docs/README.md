...
4. [Implementation Summary](03-implementation/implementation-summary.md) - Phase별 구현 내역
5. [Operations Guide](04-operations/guides/operations-guide.md) - 일상 운영 가이드
6. [Troubleshooting](05-troubleshooting/README.md) - 문제 해결 가이드
7. [Performance](06-performance/README.md) - 성능 테스트 및 분석
8. [Demo](07-demo/demo-scenario.md) - 구조화된 Demo 시나리오
...
| [Implementation Summary](03-implementation/implementation-summary.md) | 구현 상세 및 기술 스택 |
| [Troubleshooting](05-troubleshooting/README.md) | 개발/배포 중 문제 해결 |
| [Performance](06-performance/README.md) | 부하 테스트 시나리오 및 결과 |

### 운영자

| 문서 | 설명 |
|------|------|
| [Operations Guide](04-operations/guides/operations-guide.md) | 배포 확인, 로그 조회, Scale 조정 |
| [Secret Management](secret-management.md) | Secret Rotation 및 관리 절차 |
| [Operational Changes](operational-changes.md) | 운영 변경 이력 |
| [Troubleshooting](05-troubleshooting/README.md) | 카테고리별 문제 해결 |
...
| [Retrospective](08-retrospective/project-retrospective.md) | 프로젝트 회고 및 교훈 |
...
├── TROUBLESHOOTING.md                  # 기존 Troubleshooting (레거시)

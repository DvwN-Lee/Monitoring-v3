...
- VPC Network, Subnet (10.0.1.0/24), Firewall Rules 정의
...
- Terratest 관련 9건의 문제 발생 및 해결 ([Testing Troubleshooting](../05-troubleshooting/testing/README.md))
...
- IaC 배포 문제 10건 해결 및 문서화 ([Troubleshooting](../05-troubleshooting/README.md))
